...
export default function Login(){
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
        const response = await apiDjango.post('/api/token/', { // Obtener tokens de autenticacion
            username,
            password,
        });
    ...
    return (
        ...
        <div className="bg-gray-800/40 backdrop-blur-md p-8 rounded-[2.5rem] border-2 border-blue-500/30 shadow-2xl w-full max-w-[400px] shadow-[0_0_30px_rgba(59,130,246,0.15)]">
            ...
            <div className="w-10 h-1 bg-blue-500 rounded-full mb-3 shadow-[0_0_15px_rgba(59,130,246,0.5)]" />
